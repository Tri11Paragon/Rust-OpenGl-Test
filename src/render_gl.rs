    ...
    impl Shader {
        // create shader from source. Includes kind. If no erros then create shader struct
        ...
        // creates a getter for the id of the shader. Returns GL_INT
        pub fn id(&self) -> gl::types::GLuint {
            self.id
        }
    }
    // destroys the shader at end of program. Rust insures thats its been called.
    ...
    // creates a shader from source. Takes kind and source.
